""" Setup script for the notebook_adventure application.
...
_config = {
    ...
    "url": "",
    "author": "Marley and Jamaal Kirkpatrick",
    "author_email": "kjamaal81@gmail.com",
    "package_dir": {"": "src"},
    "packages": find_packages("src"),
    "entry_points": {
        "console_scripts": ("adventure = notebook_adventure.cli:main",),
    },
    "data_files": ("etc/",),
}
